...
public class MDatePicker implements OnDateChangedListener, OnTimeChangedListener {
	private DatePicker datePicker;
	private AlertDialog ad;
	private String dateTime;
	private String initDateTime = "1991年1月1日";
	 ...
	 */
	public MDatePicker(Activity activity, String date) {
	...
	public AlertDialog dateTimePicKDialog(final Button inputDate) {
		RelativeLayout dateTimeLayout = (RelativeLayout) activity.getLayoutInflater()
				.inflate(R.layout.common_datepicker, null);
	 ...
	 * @return
	 */
	public AlertDialog pick(final OnChooseEvent event) {
		RelativeLayout dateTimeLayout = (RelativeLayout) activity.getLayoutInflater()
				.inflate(R.layout.common_datepicker, null);
		datePicker = (DatePicker) dateTimeLayout.findViewById(R.id.datepicker);
		init(datePicker);
