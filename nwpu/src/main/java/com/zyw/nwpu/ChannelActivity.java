...
import com.zyw.nwpu.adapter.DragAdapter;
import com.zyw.nwpu.adapter.OtherAdapter;
...
import com.zyw.nwpu.view.DragGrid;
import com.zyw.nwpu.view.OtherGridView;
	...
	public void onBackPressed() {
		...
		if (userAdapter.isListChanged()) {
			...
			Intent intent = new Intent(getApplicationContext(),
					News_Fragment.class);
			setResult(News_Fragment.CHANNELRESULT, intent);
			finish();
		} else {
			// 没有任何操作
			super.onBackPressed();
