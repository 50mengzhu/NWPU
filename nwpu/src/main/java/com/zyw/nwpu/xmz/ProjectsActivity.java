...
@ContentView(R.layout.activity_xmz_projectlist)
public class ProjectsActivity extends BaseActivity implements
	...
	public void initView() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				ProjectDetailActivity.startThis(ProjectsActivity.this);
			}
		});
	}

	public static void startThis(Context cxt) {
		Intent intent = new Intent(cxt, ProjectsActivity.class);
