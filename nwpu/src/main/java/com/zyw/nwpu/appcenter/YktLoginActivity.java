...
@ContentView(R.layout.activity_ykt_login)
public class YktLoginActivity extends BaseActivity implements View.OnClickListener {

	protected static final String LOGINURL = "http://222.24.192.175/npulife_api/ykt/ykt_form.php";
	protected static final String POSTURL = "http://222.24.192.175/npulife_api/ykt/ykt_get.php";
	...
	public static void startThis(Context cxt) {
		Intent intent = new Intent(cxt, YktLoginActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		sharedPreferences = this.getSharedPreferences("yktUserInfo", Context.MODE_WORLD_READABLE);
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					Toast.makeText(YktLoginActivity.this, "请检查网络设置", Toast.LENGTH_SHORT).show();
					e1.printStackTrace();
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
				VERIFATIONURL = "http://222.24.192.175/npulife_api/ykt/verifycode/verifyCode_" + JSESSIONID + ".jpg";
				...
				try {
					...
					Toast.makeText(YktLoginActivity.this, "无法读取验证码", Toast.LENGTH_SHORT).show();
					e.printStackTrace();
				}
	...
	private void showData() {
		// Intent intent = new Intent(YktLoginActivity.this,
		// FlowdataActivity.class);
