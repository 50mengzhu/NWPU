...
public class EaseChatRowImage extends EaseChatRowFile {
	...
	public EaseChatRowImage(Context context, EMMessage message, int position,
			BaseAdapter adapter) {
	...
	protected void onInflatView() {
		inflater.inflate(
				message.direct == EMMessage.Direct.RECEIVE ? R.layout.ease_row_received_picture
	...
	protected void onSetUpView() {
		...
		String filePath = imgBody.getLocalUrl();
		if (filePath != null) {
			showImageView(EaseImageUtils.getThumbnailImagePath(filePath),
					imageView, filePath, message);
		}
		handleSendMessage();
	}
			...
			new AsyncTask<Object, Void, Bitmap>() {
				...
				protected void onPostExecute(Bitmap image) {
					if (image != null) {
						...
						EaseImageCache.getInstance()
								.put(thumbernailPath, image);
					} else {
