...
public class EaseChatRowFile extends EaseChatRow {
	...
	public EaseChatRowFile(Context context, EMMessage message, int position,
			BaseAdapter adapter) {
	...
	protected void onInflatView() {
		inflater.inflate(
				message.direct == EMMessage.Direct.RECEIVE ? R.layout.ease_row_received_file
	...
	protected void onSetUpView() {
		...
		fileSizeView.setText(TextFormater.getDataSize(fileMessageBody
				.getFileSize()));
