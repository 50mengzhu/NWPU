...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
	...
	public EaseConversationAdapater(Context context, int resource, List<EMConversation> objects) {
		...
		options = Options.getHeadImageDisplayOptions();
	}
	...
	// private Map<String, UserInfo> userInfoMap = new HashMap<String,
	// UserInfo>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (conversation.getType() == EMConversationType.GroupChat) {
			...
			if (AvatarAndNicknameService.userInfoMap != null
					&& AvatarAndNicknameService.userInfoMap.containsKey(username)) {
				UserInfo info = AvatarAndNicknameService.userInfoMap.get(username);
				imageLoader.displayImage(info.avatar, holder.avatar, options);
				holder.name.setText(info.nickname);
			} else {
				AvatarAndNicknameService.getUserInfoAndSave(username, new GetUserInfoCallback() {

					@Override
					public void done() {
						if (EaseConversationAdapater.this != null)
